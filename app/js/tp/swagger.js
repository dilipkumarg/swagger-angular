...
(function() {
  ...
  SwaggerApi = (function() {
    ...
    SwaggerApi.prototype.build = function() {
      ...
      log("fetching resource list:" + this.url);
      obj = {
    ...
    SwaggerApi.prototype.buildFromSpec = function(response) {
      ...
      if (isApi) {
       ...
       // log("creating new resource for api:*buildFromSpec*:");
        ...
        for (_k = 0, _len2 = _ref2.length; _k < _len2; _k++) {
          resource = _ref2[_k];
           // log("creating new resource for non api:*buildFromSpec*:");
    ...
    SwaggerApi.prototype.buildFrom1_1Spec = function(response) {
      ...
      if (isApi) {
        newName = response.resourcePath.replace(/\//g, '');
        this.resourcePath = response.resourcePath;
        //log("creating new resource for api:buildFrom1_1Spec:");
        res = new SwaggerResource(response, this);
        this.apis[newName] = res;
        this.apisArray.push(res);
      } else {
        ...
        for (_k = 0, _len2 = _ref2.length; _k < _len2; _k++) {
          resource = _ref2[_k];
            //log("creating new resource for non api:buildFrom1_1Spec:");
          res = new SwaggerResource(resource, this);
          this.apis[res.name] = res;
          this.apisArray.push(res);
        }
    ...
    function SwaggerResource(resourceObj, api) {
      ...
      if ((resourceObj.apis != null) && (this.api.resourcePath != null)) {
       ...
       this.api.progress('fetching resource ' + this.name + ': ' + this.url);
        ...
        e.authorizations.apply(obj);
        // log("calling execute from swagger resource");
        new SwaggerHttp().execute(obj);
      }
    }
      ...
      SwaggerResource.prototype.getAbsoluteBasePath = function (relativeBasePath) {
          ...
          if (relativeBasePath.length > 0) {
              var slash = "/",
                  url = Util.baseUrl(relativeBasePath.charAt(0) !== slash) + relativeBasePath,
                  lastCharPos = url.length - 1;
              return (url.charAt(lastCharPos) === slash) ? url.substr(0, lastCharPos) : url;
  ...
  SwaggerModel = (function() {
    ...
    SwaggerModel.prototype.getMockSignature = function(modelsToIgnore) {
      ...
      function validateRefModel(refModel) {
          // for better readability writing separate if's
          if(refModel != null) {
              if(typeof refModel !== 'undefined') {
                  if(typeof refModel !== 'function') {
                      if(modelsToIgnore.indexOf(refModel) === -1) {
                          //if($.inArray(refModel, modelsToIgnore)) {
                          return true;
                      }
                  }
              }
...
/*      for (_j = 0, _len1 = _ref1.length; _j < _len1; _j++) {
        prop = _ref1[_j];
        if(validateRefModel(prop.refModel)) {
  ...
  SwaggerModelProperty = (function() {
    function SwaggerModelProperty(name, obj) {
      ...
      if (obj.allowableValues != null) {
        ...
        if (this.values != null && (typeof this.values == "Array")) {
